...
TEMPLATE_CONTEXT_PROCESSORS += (
    ...
    'bull.pages.context_processors.group_list',
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bull/devDB',  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'rk*1*%hy#l53%r*0lzdz6@)^wo_#ti4)x1=$%8-s1%j1%gqyrz'
